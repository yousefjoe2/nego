...
class ProductsWidget extends StatefulWidget {
  ...
  _ProductsWidgetState createState() =>
      _ProductsWidgetState(categoryArgs: categoryArgs);
}

class _ProductsWidgetState extends State<ProductsWidget> {
  final CategoryArguments categoryArgs;

  _ProductsWidgetState({this.categoryArgs});
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final productsBloc = Provider.of<ProductBloc>(context);
    return Scaffold(
      ...
      body: StreamBuilder<List<Product>>(
        stream: productsBloc.getProducts(
            ...
            subCategory: categoryArgs.subCategoryId),
